...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h2 class="mb-sm-0">Kategori Informasi</h2>
        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="flex-shrink-0">
                                <a href="{{ route('category_info.create') }}" class="btn btn-primary w-100"> <i class="ri-add-fill me-1 align-bottom"></i> Tambah
                                    Kategori
                                </a>
                            </div>
                        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-nowrap" id="category_info" width="100%">
...
<script>
    ...
    $(document).ready(function () {
        ...
        table = $('#category_info').DataTable({
            ...
            initComplete: function () {
                $("#category_info_filter").hide();
            },

            processing: true,
            serverSide: true,
            ajax: "{{ route('category_info.json') }}",
            columns: [{
                    data: 'DT_RowIndex'
                },
                {
    ...
    $('body').on('click', '.delete', function () {
        ...
        swal({
            ...
            $.ajax({
                type: "GET",
                url: "{{ url('category_info/delete') }}" + '/' + id,
