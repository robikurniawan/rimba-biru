        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="flex-shrink-0">
                                <a href="{{ route('faq.create') }}" class="btn btn-primary w-100"> <i class="ri-add-fill me-1 align-bottom"></i> Tambah
                ...
                <div class="table-responsive">
                    <table class="table table-hover" id="faq" width="100%">
