        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="flex-shrink-0">
                                <a href="{{ route('team.create') }}" class="btn btn-primary w-100"> <i class="ri-add-fill me-1 align-bottom"></i> Tambah
                                    Tim
                                </a>
                            </div>
                        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-nowrap" id="team" width="100%">
