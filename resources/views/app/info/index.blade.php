...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h2 class="mb-sm-0"> {{ $category->name }}</h2>
        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="flex-shrink-0">
                                <a href="{{ route('info.create') }}" class="btn btn-primary w-100"> <i class="ri-add-fill me-1 align-bottom"></i> Tambah
                                    {{ $category->name }}
                                </a>
                            </div>
                        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-nowrap" id="info" width="100%">
...
<script>
    ...
    $(document).ready(function () {
        ...
        table = $('#info').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('info.json',$category->id) }}",
            columns: [{
                    data: 'DT_RowIndex'
                },
                {
