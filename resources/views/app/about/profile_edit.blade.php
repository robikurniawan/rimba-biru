...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h2 class="mb-sm-0"><i class="ri-add-fill me-1 align-bottom"></i>  Edit Profile</h2>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('about.profil_update') }}" method="POST" enctype="multipart/form-data"  data-parsley-validate>
                    ...
                    <input type="hidden" name="direct" value="{{ route('about.profil') }}">
                    <div class="mb-3">
                        <label for="" >Profile</label>
                        <textarea name="profile" class="form-control" id="editor" id="" cols="30" rows="10">{{ $get->profile }}</textarea>
                    </div>
                    <div class="mb-3">
