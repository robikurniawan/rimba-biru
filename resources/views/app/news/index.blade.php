        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="flex-shrink-0">
                                <a href="{{ route('news.create') }}" class="btn btn-primary w-100"> <i class="ri-add-fill me-1 align-bottom"></i> Tambah
                                    {{ $category->name }}
                                </a>
                            </div>
                        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-nowrap" id="news" width="100%">
...
<script>
    ...
    $(document).ready(function () {
        ...
        table = $('#news').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ route('news.json',$category->id) }}",
            columns: [{
                    data: 'DT_RowIndex'
                },
                {
